  ...
  return (
        <div className='input-section' style={style}>
            ...
            <div className='standard-input' style={{...style}}>
              <input disabled={disabled} style={{color: defaultValue ? '#000000': 'inherit'}} value={defaultValue} className='input-field' placeholder={placeholder} onChange={(e)=>handleSelectChange(e)} />
